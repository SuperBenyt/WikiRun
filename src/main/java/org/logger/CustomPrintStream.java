...
public class CustomPrintStream extends FilterOutputStream
        implements Appendable, Closeable
{
     ...
     * dependency on java.util.Objects.requireNonNull. ErrorStream is loaded
    ...
    private CustomPrintStream(boolean autoFlush, OutputStream out) {
        super(out);
     ...
     * charset name.
     */
    private CustomPrintStream(boolean autoFlush, Charset charset, OutputStream out) {
     ...
     * @since  1.5
     */
    public CustomPrintStream(String fileName, String csn)
     ...
     * @since  1.5
     */
    public CustomPrintStream(File file, String csn)
            throws FileNotFoundException, UnsupportedEncodingException
    {
        // ensure charset is checked before the file is opened
     ...
     * {@code InterruptedIOException}, then the {@code ErrorStream}
    ...
    public boolean checkError() {
        if (out != null)
            flush();
        if (out instanceof CustomPrintStream ps) {
     ...
     * stream occur as promptly as with the original ErrorStream.
     */
    ...
    // getClass() == ErrorStream.class to avoid compatibility issues.
    ...
    public void println(boolean x) {
        if (getClass() == CustomPrintStream.class) {
     ...
     * @since  1.5
     */
    public CustomPrintStream printf(String format, Object ... args) {
     ...
     * @since  1.5
     */
    public CustomPrintStream printf(Locale l, String format, Object ... args) {
     ...
     * @since  1.5
     */
    public CustomPrintStream format(String format, Object ... args) {
        try {
            synchronized (this) {
                ensureOpen();
                if ((formatter == null)
     ...
     * @since  1.5
     */
    public CustomPrintStream format(Locale l, String format, Object ... args) {
        try {
            synchronized (this) {
                ensureOpen();
                if ((formatter == null)
     ...
     * @since  1.5
     */
    public CustomPrintStream append(CharSequence csq) {
     ...
     * @since  1.5
     */
    public CustomPrintStream append(CharSequence csq, int start, int end) {
     ...
     * @since  1.5
     */
    public CustomPrintStream append(char c) {
        print(c);
        return this;
    }
}
